...
class TRPOAgentBase(object):
    ...
    def __init__(self, env):
        ...
        print "Action area, high:",env.action_space.high,"   low:", env.action_space.low
    ...
    def get_action(self, obs, action_histories, *args):
        # location = np.array(location)
        # print location.shape,"ass"

        # print action_histories.shape,"asjbdiuasndoasd"
        ...
        action_dist_means_n, action_dist_stds_n = self.session.run([self.net.action_dist_means_n, self.action_dist_stds_n],
                                               {self.net.obs: obs,self.net.action_histories: action_histories})
        if pms.train_flag:
    ...
    def train_mini_batch(self, parallel=False, linear_search=True):
        ...
        # location_n = sample_data["locations"]
        action_histories_n = sample_data["action_histories"]
        ...
        # location_n = location_n[inds]
        action_histories_n = action_histories_n[inds]
        ...
        feed = {self.net.obs: obs_n,
                ...
                # self.net.location: location_n
                self.net.action_histories: action_histories_n
                }
